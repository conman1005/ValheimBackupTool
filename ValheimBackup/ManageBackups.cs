 ...
 *    Time of Last Edit: 2024-06-24 03:18 AM
 * 
...
namespace ValheimBackup
{
    public partial class ManageBackups : Form
    {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            DialogResult confirm = MessageBox.Show("Are you sure you want to delete this?", "Confirm Deletion", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
